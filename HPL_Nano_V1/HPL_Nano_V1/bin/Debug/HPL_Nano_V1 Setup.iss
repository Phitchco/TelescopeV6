...
; Generated by Paul H on 6/19/2019 (UTC)
;
[Setup]
AppID={{767daf10-ecb6-4e47-a51b-f8b47ea41f28}
AppName=ASCOM HPL_Nano_V1 Focuser Driver
AppVerName=ASCOM HPL_Nano_V1 Focuser Driver 1
AppVersion=1
AppPublisher=Paul H <paul-hitchcock@comcast.net>
AppPublisherURL=mailto:paul-hitchcock@comcast.net
...
OutputDir="."
OutputBaseFilename="HPL_Nano_V1 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\HPL_Nano_V1"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\HPL_Nano_V1"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Paul\Library\Visual Studio 2015\Projects\HPL_Nano_V1\HPL_Nano_V1\bin\Debug\HPL_Nano_V1.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Paul\Library\Visual Studio 2015\Projects\HPL_Nano_V1\HPL_Nano_V1\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\HPL_Nano_V1.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\HPL_Nano_V1.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\HPL_Nano_V1.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\HPL_Nano_V1.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\HPL_Nano_V1.dll"""; Flags: runhidden 64bit; Check: IsWin64
